			...
			<div className="section-container">
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					...
					<div className="relative">
						{/* Map container */}
						<div className="relative aspect-[4/3] bg-space-800 rounded-2xl overflow-hidden">
							...
							{/* Overlay stats */}
							<div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-space-900/90 to-transparent p-6">
								<div className="grid grid-cols-3 gap-4 text-center">
									...
									<div>
										...
										<div className="text-xs text-slate-400">Certified Installers</div>
									</div>
									<div>
										<div className="text-2xl font-bold text-white">3-5</div>
										<div className="text-xs text-slate-400">Day Avg. Install</div>
									</div>
								</div>
							</div>
						</div>
